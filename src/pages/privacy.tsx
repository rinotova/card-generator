  ...
  return (
    <CenteredLayout>
      <div className="max-w-screen-sm text-white">
        <div id="placeholders">
          <Heading>Privacy Policy of Business Card Generator</Heading>
          <p>
            ...
            website, which provides the service of generatin digital business
            cards.
          </p>
          <p>
          ...
          <p>
            ...
            <span className="highlight preview_website_url">Website URL</span>,
          ...
          <p>
            ...
            computer`&rsquo;` Internet Protocol (“IP”) address, browser version,
          ...
          <p>
            ...
            website that you visit and are stored on your computer`&rsquo;` hard
            drive.
          </p>
          <p>
