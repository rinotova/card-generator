  ...
  return (
    <CenteredLayout>
      <div className="max-w-screen-sm text-white">
        ...
        <p>Welcome to Business card generator</p>
        ...
        <p>
          ...
          conditions. Do not continue to use Business card generator if you do
        ...
        <p>
          Unless otherwise stated, Business card generator and/or its licensors
          own the intellectual property rights for all material on Business card
          generator. All intellectual property rights are reserved. You may
          access this from Business card generator for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Business card generator</li>
          <li>
            Sell, rent or sub-license material from Business card generator
          </li>
          <li>
            Reproduce, duplicate or copy material from Business card generator
          </li>
          <li>Redistribute content from Business card generator</li>
        </ul>
        ...
        <p>
          ...
          Business card generator does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Business card generator,its agents
          ...
          applicable laws, Business card generator shall not be liable for the
        ...
        <p>
          Business card generator reserves the right to monitor all Comments and
        ...
        <p>
          You hereby grant Business card generator a non-exclusive license to
        ...
        <p>
          ...
          the hyperlink compensates the absence of Business card generator; and
        ...
        <p>
          ...
          sending an e-mail to Business card generator. Please include your
