...
function SkeletonCard() {
  return (
    <div
      role="status"
      className="flex  animate-pulse items-center space-y-0 space-x-6"
    >
      <div className="flex h-24 w-32 items-center justify-center rounded bg-gray-300 dark:bg-gray-700 ">
        <svg
